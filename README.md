...
Response is always contain `message` field, to warn user which have been affected
...
Fork: https://github.com/cryptlex/rest-api-response-format#rest-api-error-responses
Error handling: https://codedamn.com/news/backend/advanced-error-handling-in-rest-apis
Api example: https://www.postman.com/twitter/workspace/twitter-s-public-workspace
